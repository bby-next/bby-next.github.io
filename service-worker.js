...
toolbox.router.get(/\/multimedia.bbycastatic.ca\/multimedia\//, toolbox.cacheFirst, {"cache":{"maxEntries":200,"name":"items-cache"}});
toolbox.router.get(/\/data\/categories\/.*json/, toolbox.fastest, {"cache":{"maxEntries":100,"name":"data-cache"}});
toolbox.router.get(/\/data\/i18n\/.*json/, toolbox.fastest, {"cache":{"maxEntries":100,"name":"data-cache"}});



>>>>>>> parent of ddcdf4a... fixed redirect loop
